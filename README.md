...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Inertia.js-💨-purple?style=for-the-badge" />
  <img src="https://img.shields.io/badge/TailwindCSS-3-38B2AC?style=for-the-badge" />
...
It integrates role-based dashboards, map-based route viewing, resident communication, and administrative controls to optimize waste collection operations.
...
- Displays **collection routes**, **pickup points**, and **district/purok boundaries**
- Supports **markers** and **polylines**
- Used by both **Drivers** and **Residents** for viewing planned routes and schedule maps
