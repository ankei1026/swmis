...
class ResidentWasteTrackerController extends Controller
{
    ...
    {
        // Get all active schedules with their drivers and progress - Same as MonitoringController
        ...
        // Get all drivers with their current locations - Same as MonitoringController
        ...
        // Keep the resident view but pass the same data
    ...
    // API endpoint for real-time updates - Same as MonitoringController
