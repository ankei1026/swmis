    ...
    const handleDelete = (id: number) => {
        toast.warning('Are you sure you want to delete this station route?', {
            action: {
                label: 'Confirm',
                onClick: () => {
                    router.delete(route('driver.stationroute.destroy', id), {
                        preserveScroll: true,
        ...
        popup: (
            <div className="space-y-2 text-sm">
                ...
                <div className="flex gap-2 mt-2">
                    <button
                        onClick={() => router.get(route('driver.stationroute.edit', station.id))}
    ...
    return (
        <Layout>
            ...
            <div className="mb-6 flex justify-between items-center">
                ...
                <button
                    onClick={() => router.get(route('driver.stationroute.create'))}
