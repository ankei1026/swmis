...
import { mainMenuResident, secondaryMenuResident } from '../menuItems';
...
export const DrawerResident = ({ open, onClose }: DrawerProps) => {
    ...
    return (
        <DrawerStyled variant="permanent" open={open}>
            ...
            <Divider />
            <List>{renderMenu(mainMenuResident)}</List>
            <Divider />
            <List>{renderMenu(secondaryMenuResident)}</List>
            <Divider sx={{ mt: 'auto' }} />
            <UserProfileSectionResident open={open} />
        </DrawerStyled>
    );
};
