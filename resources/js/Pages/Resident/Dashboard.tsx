...
const Dashboard = () => {
    ...
    return (
        <LayoutResident title="Dashboard">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    <Card className="bg-green-50">
                        <CardContent className="flex items-center gap-4 p-4">
                            ...
                            <div>
                                <h4 className="text-sm text-gray-500">Total Collections</h4>
                                <p className="text-xl font-bold text-green-700">{totalCollections}</p>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-blue-50">
                        <CardContent className="flex items-center gap-4 p-4">
                            ...
                            <div>
                                <h4 className="text-sm text-gray-500">Successful</h4>
                                <p className="text-xl font-bold text-blue-700">{totalSuccess}</p>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-red-50">
                        <CardContent className="flex items-center gap-4 p-4">
                            ...
                            <div>
                                <h4 className="text-sm text-gray-500">Failed</h4>
